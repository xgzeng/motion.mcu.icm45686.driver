 ...
 */
typedef int (*inv_imu_read_reg_t)(void *t, uint8_t reg, uint8_t *buf, uint32_t len);
 ...
 *  @return         0 on success, negative value on error.
 */
typedef int (*inv_imu_write_reg_t)(void *t, uint8_t reg, const uint8_t *buf, uint32_t len);
